...
This file is the Gemini CLI `GEMINI.md` context convention. The agent-agnostic
source is `AGENTS.md`, mirrored per-agent under `.cursor/`, `.windsurf/`,
`.clinerules/`, `.kiro/`, and `.github/copilot-instructions.md`. Source of
truth: [`skills/comb/SKILL.md`](./skills/comb/SKILL.md).
